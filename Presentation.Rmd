...
knitr::include_graphics("images/workflow_1.png")

```

- need to change figure 4 to figure 5
- add a figure 4 as preprocessing with data augmentations

---
## Figure 2: Data Preprocessing without augmentations
...
---
## Figure 4: Preprocessing with data augmentations
...
Figure 5: Analyse Effects of Noise on CNN Models (maybe we do not need a figure)
