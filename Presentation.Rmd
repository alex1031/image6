...
```{r echo=FALSE, out.width="550px", out.height="550px", fig.align='center'}
...
- **Noise** in data augmentation enlarges the training dataset by introducing random variations to input variables (Maulana, n.d.). This process improves model generalization, loss function and overfitting (Bishop, 1995; Maulana, n.d.) (Shanqing; Pednekar & Slater, 2019).


- **Image Resolution** is vital in deep learning applications like radiology. High resolution offers more information, but lower resolutions can sometimes enhance model performance by reducing overfitting risks (Sabottke & Spieler, 2020).

- **Image rotation**, a key data augmentation strategy, enhances machine learning models' performance by diversifying cell observations (Mikołajczyk & Grochowski, 2018). 


---
Figure 3: Result Collection Process
...
As a team we developed this shared interactive tool to assess how the model’s performance and robustness vary with different types of data augmentation factors. 
