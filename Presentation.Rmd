...
- **Improving Model:** Run the model multiple times to get the average validation accuracy 

- **Medial Analysis:** skin melanomas diagnosis, histopathological images, & breast magnetic resonance imaging (MRI) scans analysis, utilising the image classification in order to produce a diagnose (Mikołajczyk & Grochowski, 2018). 
