...
## 0.4 mean gaussian noise

```{r}
temp <- add_gaussian_noise(imgs_masked_resize_64[[5]]@.Data - mean(imgs_masked_resize_64[[5]]@.Data), mean = 0.4)
display(temp, method = "raster")
```
...
set.seed(40)
for (i in 1:num_images) {
  noise_x[i,,,1] <- add_gaussian_noise(imgs_masked_resize_64[[i]]@.Data - mean(imgs_masked_resize_64[[i]]@.Data), mean = 0.4)
}
...
#save_model_tf(model_catent, "models/cnn_catent_noise04")
#save_model_tf(model_catent, "models/cnn_catent_cweights_noise04")
```
...
#save_model_tf(model_binary, "models/cnn_binary_noise04")
#save_model_tf(model_binary, "models/cnn_binary_cweights_noise04")
```
...
#save_model_tf(model_rmsprop, "models/cnn_rmsprop_cweights_noise04")
#save_model_tf(model_rmsprop, "models/cnn_rmsprop_noise04")
```
